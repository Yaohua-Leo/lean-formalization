# lean-formalization acceptance — 20260921T051455Z-2e9e8d
...
| opencode-mcp-list | no | 0 | 2 | informational: does OpenCode read the opencode.json we wrote? (run outside a git repo: OpenCode itself may be refused permission to spawn git/uvx inside a sandbox — that is not a config failure) |
